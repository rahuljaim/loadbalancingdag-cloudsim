...
public class InternetCharacteristics {
	...
	private InternetCharacteristics() throws IOException, URISyntaxException{
		...
		latencyMatrix = (double[][]) IOUtil.loadFromXml(new File("resources/"+Constants.DELAYMATRIX_FILE));
		bwMatrix = (double[][]) IOUtil.loadFromXml(new File("resources/"+Constants.BWMATRIX_FILE));
