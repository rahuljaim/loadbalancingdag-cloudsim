	...
	public DatacenterController(String name, 
		...
		if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_ACTIVE)){
			...
			this.loadBalancer = new RoundRobinVmLoadBalancer(vmStatesList);
               ...
               // else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_GSO)){
		//	this.loadBalancer = new GSOBalancer(vmStatesList);
                        
		//} 
              //  else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_TLBO)){
			//this.loadBalancer = new TLBOBalancer(vmStatesList);
               // }
                 else if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_GA)){
			this.loadBalancer = new GABalance(vmStatesList);
                 }
		...
		//}
			...
			this.loadBalancer = new PSOBalancer(vmStatesList);
                 }
	}
