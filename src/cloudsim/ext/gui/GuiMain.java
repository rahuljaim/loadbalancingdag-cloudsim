...
private static final String CMD_ABOUT = "About";
	...
	public GuiMain() throws Exception{	
                System.out.println("Modification of Load Balancing Policy");
	...
	private void initUI(){		
		this.setTitle(" Modification of Load Balancing Policy By Directed Acyclic Graph ");
	...
	private void showHomeScreen(){
		...
		if (simulationStarted){
			...
			if (btnCancelSim == null){
				btnCancelSim = new JButton("Cancel Sim");
	...
	public static void main(String[] args){
		   GuiMain app;
                  ...
                  System.out.println("Process of simulation");
