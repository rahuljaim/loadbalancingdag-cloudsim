...
public class ConfigureSimulationPanel extends JPanel
    ...
    /**
     * Creates local (deep) copies of the user base and data center lists. Need
     * copies as we don't want to update the original copies in
     * {@link Simulation} until user clicks 'Done' button.
     */
    ...
    private JPanel createAdvancedTab() {
        ...
        cmbLoadBalancingPolicy = new JComboBox(new String[]{
            ...
            Constants.LOAD_BALANCE_GA,  Constants.LOAD_BALANCE_PSO});
